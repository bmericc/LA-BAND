...
function site5framework_header_init() {
    if (!is_admin()) {
        ...
        wp_register_script( 'modernizr', get_template_directory_uri().'/library/js/modernizr-2.6.1.min.js', array(), null, true);
        wp_enqueue_script( 'modernizr' );
        wp_enqueue_script( 'selectivizr', get_template_directory_uri().'/library/js/libs/selectivizr-min.js', array(), null, true);

        wp_enqueue_script( 'superfishjs', get_template_directory_uri().'/library/js/superfish.js',  array( 'jquery' ), null, true);
        wp_enqueue_script( 'prettyphotojs', get_template_directory_uri().'/library/js/prettyphoto/jquery.prettyPhoto.js',  array( 'jquery' ), null, true);
//        wp_enqueue_script( 'audiojs', get_template_directory_uri().'/library/js/audio/audio.js',  array( 'jquery' ), null, true);
        //wp_enqueue_script('tiptipjs', get_template_directory_uri().'/library/js/tiptip/jquery.tipTip.js', array( 'jquery' ));
        wp_enqueue_script('buttonsjs', get_template_directory_uri().'/lib/shortcodes/js/buttons.js', array(), null, true);
        wp_enqueue_script('quovolverjs', get_template_directory_uri().'/lib/shortcodes/js/jquery.quovolver.js', array( 'jquery' ), array(), null, true);
        wp_enqueue_script('cyclejs', get_template_directory_uri().'/lib/shortcodes/js/jquery.cycle.all.min.js', array( 'jquery' ), array(), null, true);
