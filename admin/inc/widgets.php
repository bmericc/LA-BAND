...
add_action( 'widgets_init', function() { return register_widget( "site5framework_twitter_widget" ); } );
...
// Initialize the widget
add_action( 'widgets_init', function() { return register_widget( "site5framework_contact_widget" ); } );
...
// Initialize the widget
add_action( 'widgets_init', function() { return register_widget( "site5framework_video_widget" ); } );
