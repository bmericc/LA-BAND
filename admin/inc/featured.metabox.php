...
$featured_meta_box = array(
	...
	'fields' => array(
		...
		array(
			'name' => 'Slide Caption 1',
			'desc' => '',
			'id' => $prefix . 'fitemcaption1',
			'type' => 'text',
			'std' => ''
		),

        array(
            'name' => 'Slide Caption 2',
            'desc' => '',
            'id' => $prefix . 'fitemcaption2',
            'type' => 'text',
            'std' => '',
        ),
		...
		array(
            ...
            'desc' => 'To ensure the best viewing experience, please make sure that the image size is 1920px x 1080px',
