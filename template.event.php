            ...
            <div id="white-background">
                ...
                <div id="content" class="container clearfix">
                    ...
                    <div class="container clearfix">
                        <ul id="event-items"  class="container" style="margin-bottom: 0;">
                            <?php
                            global $post;
                            ...
                            while ( have_posts()):the_post();
                                ...
                                <!-- PROJECT ITEM STARTS -->
                                    <li class="full-width-block clearfix <?php foreach ($categories as $category) { echo $category->slug. ' '; } ?>" data-id="id-<?php the_ID(); ?>" data-type="<?php foreach ($categories as $category) { echo $category->slug. ' '; } ?>">
